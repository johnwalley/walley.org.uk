...
export const article = {
  author: 'John Walley',
  date: '2025-06-17',
  title: "Advice I'd give a younger self",
  description:
    'On trade-offs, incidental complexity, and knowing when to ask the question.',
}

export const metadata = createArticleMetadata(article, 'programming-advice')
